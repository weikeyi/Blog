...
export const siteConfig: SiteConfig = {
    // 站点 URL（以斜杠结尾）
    siteURL: "https://blog.990719.xyz/", // 请替换为你的站点 URL 并以斜杠结尾
    // 站点标题
    title: "可以歇歇",
    // 站点副标题
    ...
    font: {
        ...
        // JetBrains Mono 字体 (等宽字体，适合代码风格)
        jetBrainsMono: {
            // 作为全局字体
            enable: false,
        },
        // 霞鹜文楷字体 (中文用霞鹜文楷，英文用 JetBrains Mono)
        lxgwWenKai: {
            // 作为全局字体
            enable: true,
        },
    ...
    wallpaper: {
        ...
        src: {
            ...
            desktop: [
                "/assets/desktop-banner/background.png",
            ],
            // 移动壁纸图片 (支持单张图片或图片数组，当数组长度 > 1 时自动启用轮播)
            mobile: [
                "/assets/mobile-banner/background.png",
            ],
        },
